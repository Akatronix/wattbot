...
//   // Function to format numbers properly (remove trailing zeros)
//   const formatNumber = (num) => {
//     if (num === null || num === undefined || isNaN(num)) {
//       return "0";
//     }
    
//     // Convert to string and handle trailing zeros
...
//             <CardContent>
//               <div className="text-2xl font-bold">
//                 {formatNumber(deviceUsageData.totalPower)} KW
//               </div>
//               <p className="text-xs text-muted-foreground">
//                 {deviceCounts.activeDevices} of {deviceCounts.totalDevices}{" "}
//                 devices active
...
//               <CardDescription>
//                 {deviceUsageData.topDevice
//                   ? `Top consumer: ${deviceUsageData.topDevice.name} (${formatNumber(deviceUsageData.topDevice.power)}KW)`
//                   : "No active devices"}
//               </CardDescription>
//             </CardHeader>
//             <CardContent>
...
//   // Function to format numbers properly (remove trailing zeros and convert to integer)
//   const formatNumber = (num) => {
//     if (num === null || num === undefined || isNaN(num)) {
//       return "0";
//     }
...
//   // Function to format power with KW unit (only shows KW when value > 0)
//   const formatPower = (num) => {
//     const formattedValue = formatNumber(num);
//     return formattedValue === "0" ? "0" : `${formattedValue} KW`;
//   };
...
//             <CardContent>
//               <div className="text-2xl font-bold">
//                 {formatPower(deviceUsageData.totalPower)}
//               </div>
//               <p className="text-xs text-muted-foreground">
//                 {deviceCounts.activeDevices} of {deviceCounts.totalDevices}{" "}
//                 devices active
...
//                               {getDeviceTypeName(item.type)}:
//                             </span>{" "}
//                             {formatNumber(item.percentage)}% ({formatPower(item.power)})
//                           </div>
//                         </div>
//                       )
//                     )}
...
//               <CardDescription>
//                 {deviceUsageData.topDevice
//                   ? `Top consumer: ${deviceUsageData.topDevice.name} (${formatPower(deviceUsageData.topDevice.power)})`
//                   : "No active devices"}
//               </CardDescription>
//             </CardHeader>
//             <CardContent>
...
const DashboardContent = () => {
  ...
  // Function to format power with KW unit (only shows when value > 0)
  const formatPower = (num) => {
    const formattedValue = formatNumber(num);
    return formattedValue === "0" ? null : `${formattedValue} KW`;
  };
  ...
  // Get formatted power values
  const currentUsagePower = formatPower(deviceUsageData.totalPower);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              {deviceUsageData.deviceTypeDistribution.length > 0 ? (
                <div className="flex flex-col items-center">
                  ...
                  <div className="grid grid-cols-2 gap-2 w-full">
                    {deviceUsageData.deviceTypeDistribution.map(
                      (item, index) => {
                        const powerDisplay = formatPower(item.power);
                        return (
                          <div key={index} className="flex items-center">
                            <div
                              className="w-3 h-3 rounded-full mr-2"
                            ...
                            <div className="text-sm">
                              ...
                              {formatNumber(item.percentage)}% {powerDisplay && `(${powerDisplay})`}
                            </div>
                          </div>
                        );
                      }
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {deviceUsageData.topDevice
                  ? `Top consumer: ${deviceUsageData.topDevice.name} ${formatPower(deviceUsageData.topDevice.power) ? `(${formatPower(deviceUsageData.topDevice.power)})` : ''}`
                  : "No active devices"}
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                {deviceUsageData.devices.length > 0 ? (
                  deviceUsageData.devices.map((device) => {
                    const powerDisplay = formatPower(device.power);
                    return (
                      <div
                        key={device.id}
                        className="flex items-center justify-between"
